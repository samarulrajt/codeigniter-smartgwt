            ...
            <div class="box">
                ...
                <form method="POST" id="form_Nhật Ký HàNh Trình" action="http://localhost/vehicle/index.php/c_nhat_ki_hanh_trinh/">
                    ...
                    <label>
                        ...
                        <input type="text" name="diemdiemKH" value="" id="diemdiemKH" class="input-text" onchange="Nhat_ki_hanh_trinh.setDataField(this.name,this.value);"  />
                    </label>                    
                                        
                    <label>
                        <span>diemdiemKT</span>
                        <input type="text" name="diemdiemKT" value="" id="diemdiemKT" class="input-text" onchange="Nhat_ki_hanh_trinh.setDataField(this.name,this.value);"  />
                    </label>                    
                                        
                    <label>
                        <span>Ngày khởi hành</span>
                        <input type="text" name="NGAY_KHOI_HANH" value="" id="NGAY_KHOI_HANH" class="input-text" onchange="Nhat_ki_hanh_trinh.setDataField(this.name,this.value);"  />
                    </label>                    
